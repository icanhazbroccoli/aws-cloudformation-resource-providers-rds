...
public class CreateHandlerTest extends AbstractHandlerTest {
    ...
    public void handleRequest_RestoreDBInstanceFromSnapshot_Success() {
        ...
        test_handleRequest_base(context, () -> DB_INSTANCE_ACTIVE, () -> RESOURCE_MODEL_RESTORING_FROM_SNAPSHOT, expectSuccess());

        verify(rdsProxy.client()).restoreDBInstanceFromDBSnapshot(any(RestoreDbInstanceFromDbSnapshotRequest.class));
    ...
    public void handleRequest_RestoreDBInstanceFromSnapshot_AlreadyExists() {
        ...
        test_handleRequest_base(context, null, () -> RESOURCE_MODEL_RESTORING_FROM_SNAPSHOT, expectFailed(HandlerErrorCode.AlreadyExists));
    }
    ...
    public void handleRequest_RestoreDBInstanceFromSnapshot_RuntimeException() {
        ...
        test_handleRequest_base(context, null, () -> RESOURCE_MODEL_RESTORING_FROM_SNAPSHOT, expectFailed(HandlerErrorCode.InternalFailure));
    }
    ...
    public void handleRequest_CreateReadReplica_Create_InProgress() {
        ...
        test_handleRequest_base(context, () -> DB_INSTANCE_ACTIVE, () -> RESOURCE_MODEL_READ_REPLICA, expectSuccess());

        verify(rdsProxy.client()).createDBInstanceReadReplica(any(CreateDbInstanceReadReplicaRequest.class));
        verify(rdsProxy.client(), times(2)).describeDBInstances(any(DescribeDbInstancesRequest.class));
    }
    ...
    public void handleRequest_CreateReadReplica_AlreadyExists() {
        ...
        test_handleRequest_base(context, null, () -> RESOURCE_MODEL_READ_REPLICA, expectFailed(HandlerErrorCode.AlreadyExists));
    }
    ...
    public void handleRequest_CreateReadReplica_RuntimeException() {
        ...
        test_handleRequest_base(context, null, () -> RESOURCE_MODEL_READ_REPLICA, expectFailed(HandlerErrorCode.InternalFailure));
    }
    ...
    public void handleRequest_CreateNewInstance_AlreadyExists() {
        ...
        test_handleRequest_base(context, null, () -> RESOURCE_MODEL_BLDR().build(), expectFailed(HandlerErrorCode.AlreadyExists));
    }
    ...
    public void handleRequest_CreateNewInstance_RuntimeException() {
        ...
        test_handleRequest_base(context, null, () -> RESOURCE_MODEL_BLDR().build(), expectFailed(HandlerErrorCode.InternalFailure));
    }
    ...
    public void handleRequest_CreateNewInstance_Success() {
        ...
        test_handleRequest_base(context, () -> DB_INSTANCE_ACTIVE, () -> RESOURCE_MODEL_BLDR().build(), expectSuccess());
    ...
    public void handleRequest_CreateNewInstance_UpdateRoles_Success() {
        ...
        test_handleRequest_base(context, transitions::remove, () -> RESOURCE_MODEL_BLDR().build(), expectSuccess());
    ...
    public void handleRequest_CreateNewInstance_NoIdentifier_InProgress() {
        ...
        test_handleRequest_base(context, () -> DB_INSTANCE_ACTIVE, () -> RESOURCE_MODEL_NO_IDENTIFIER, expectSuccess());

        verify(rdsProxy.client(), times(2)).describeDBInstances(any(DescribeDbInstancesRequest.class));
        verify(rdsProxy.client()).createDBInstance(any(CreateDbInstanceRequest.class));
    }
    ...
    public void handleRequest_CreateNewInstance_ShouldUpdateAfterCreate_CACertificateIdentifier_Success() {
        ...
        test_handleRequest_base(context, () -> dbInstance, () -> Translator.translateDbInstanceFromSdk(dbInstance), expectSuccess());
    ...
    @Test
    public void handleRequest_CreateReadReplica_AllocatedStorage_ShouldUpdate_Succeess() {
        final ModifyDbInstanceResponse modifyDbInstanceResponse = ModifyDbInstanceResponse.builder().build();
        when(rdsProxy.client().modifyDBInstance(any(ModifyDbInstanceRequest.class))).thenReturn(modifyDbInstanceResponse);
